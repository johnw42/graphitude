...
impl Attr {
    ...
    pub fn value(&self) -> String {
        match self {
            Attr::_background(v) => v.to_string(),
            Attr::URL(v) => v.to_string(),
            Attr::Area(v) => v.to_string(),
            Attr::Arrowhead(v) => v.to_string(),
            Attr::Arrowsize(v) => v.to_string(),
            Attr::Arrowtail(v) => v.to_string(),
            Attr::Bb(v) => v.to_string(),
            Attr::Beautify(v) => v.to_string(),
            Attr::Bgcolor(v) => {
                let colors: Vec<String> = v.iter().map(|c| c.to_string()).collect();
                colors.join(":")
            }
            Attr::Center(v) => v.to_string(),
            Attr::Charset(v) => v.to_string(),
            Attr::Class(v) => v.to_string(),
            Attr::Cluster(v) => v.to_string(),
            Attr::Clusterrank(v) => v.to_string(),
            Attr::Color(v) => {
                let colors: Vec<String> = v.iter().map(|c| c.to_string()).collect();
                colors.join(":")
            }
            Attr::Colorscheme(v) => v.to_string(),
            Attr::Comment(v) => v.to_string(),
            Attr::Compound(v) => v.to_string(),
            Attr::Concentrate(v) => v.to_string(),
            Attr::Constraint(v) => v.to_string(),
            Attr::Damping(v) => v.to_string(),
            Attr::Decorate(v) => v.to_string(),
            Attr::Defaultdist(v) => v.to_string(),
            Attr::Dim(v) => v.to_string(),
            Attr::Dimen(v) => v.to_string(),
            Attr::Dir(v) => v.to_string(),
            Attr::DiredgeconstraintsString(v) => v.to_string(),
            Attr::DiredgeconstraintsBool(v) => v.to_string(),
            Attr::Distortion(v) => v.to_string(),
            Attr::Dpi(v) => v.to_string(),
            Attr::Edgehref(v) => v.to_string(),
            Attr::Edgetarget(v) => v.to_string(),
            Attr::Edgetooltip(v) => v.to_string(),
            Attr::EdgeURL(v) => v.to_string(),
            Attr::Epsilon(v) => v.to_string(),
            Attr::EsepDouble(v) => v.to_string(),
            Attr::EsepPoint(v) => v.to_string(),
            Attr::Fillcolor(v) => {
                let colors: Vec<String> = v.iter().map(|c| c.to_string()).collect();
                colors.join(":")
            }
            Attr::FixedsizeBool(v) => v.to_string(),
            Attr::FixedsizeString(v) => v.to_string(),
            Attr::Fontcolor(v) => v.to_string(),
            Attr::Fontname(v) => v.to_string(),
            Attr::Fontnames(v) => v.to_string(),
            Attr::Fontpath(v) => v.to_string(),
            Attr::Fontsize(v) => v.to_string(),
            Attr::Forcelabels(v) => v.to_string(),
            Attr::Gradientangle(v) => v.to_string(),
            Attr::Group(v) => v.to_string(),
            Attr::Head_lp(v) => v.to_string(),
            Attr::Headclip(v) => v.to_string(),
            Attr::Headhref(v) => v.to_string(),
            Attr::Headlabel(v) => v.to_string(),
            Attr::Headport(v) => v.to_string(),
            Attr::Headtarget(v) => v.to_string(),
            Attr::Headtooltip(v) => v.to_string(),
            Attr::HeadURL(v) => v.to_string(),
            Attr::Height(v) => v.to_string(),
            Attr::Href(v) => v.to_string(),
            Attr::Id(v) => v.to_string(),
            Attr::Image(v) => v.to_string(),
            Attr::Imagepath(v) => v.to_string(),
            Attr::Imagepos(v) => v.to_string(),
            Attr::ImagescaleBool(v) => v.to_string(),
            Attr::ImagescaleString(v) => v.to_string(),
            Attr::Inputscale(v) => v.to_string(),
            Attr::K(v) => v.to_string(),
            Attr::Label(v) => v.to_string(),
            Attr::Label_scheme(v) => v.to_string(),
            Attr::Labelangle(v) => v.to_string(),
            Attr::Labeldistance(v) => v.to_string(),
            Attr::Labelfloat(v) => v.to_string(),
            Attr::Labelfontcolor(v) => v.to_string(),
            Attr::Labelfontname(v) => v.to_string(),
            Attr::Labelfontsize(v) => v.to_string(),
            Attr::Labelhref(v) => v.to_string(),
            Attr::Labeljust(v) => v.to_string(),
            Attr::Labelloc(v) => v.to_string(),
            Attr::Labeltarget(v) => v.to_string(),
            Attr::Labeltooltip(v) => v.to_string(),
            Attr::LabelURL(v) => v.to_string(),
            Attr::Landscape(v) => v.to_string(),
            Attr::Layer(v) => v.to_string(),
            Attr::Layerlistsep(v) => v.to_string(),
            Attr::Layers(v) => v.to_string(),
            Attr::Layerselect(v) => v.to_string(),
            Attr::Layersep(v) => v.to_string(),
            Attr::Layout(v) => v.to_string(),
            Attr::Len(v) => v.to_string(),
            Attr::Levels(v) => v.to_string(),
            Attr::Levelsgap(v) => v.to_string(),
            Attr::Lhead(v) => v.to_string(),
            Attr::Lheight(v) => v.to_string(),
            Attr::Linelength(v) => v.to_string(),
            Attr::Lp(v) => v.to_string(),
            Attr::Ltail(v) => v.to_string(),
            Attr::Lwidth(v) => v.to_string(),
            Attr::MarginDouble(v) => v.to_string(),
            Attr::MarginPoint(v) => v.to_string(),
            Attr::Maxiter(v) => v.to_string(),
            Attr::Mclimit(v) => v.to_string(),
            Attr::Mindist(v) => v.to_string(),
            Attr::Minlen(v) => v.to_string(),
            Attr::Mode(v) => v.to_string(),
            Attr::Model(v) => v.to_string(),
            Attr::Newrank(v) => v.to_string(),
            Attr::Nodesep(v) => v.to_string(),
            Attr::Nojustify(v) => v.to_string(),
            Attr::NormalizeDouble(v) => v.to_string(),
            Attr::NormalizeBool(v) => v.to_string(),
            Attr::Notranslate(v) => v.to_string(),
            Attr::Nslimit(v) => v.to_string(),
            Attr::Nslimit1(v) => v.to_string(),
            Attr::Oneblock(v) => v.to_string(),
            Attr::Ordering(v) => v.to_string(),
            Attr::OrientationDouble(v) => v.to_string(),
            Attr::OrientationString(v) => v.to_string(),
            Attr::Outputorder(v) => v.to_string(),
            Attr::OverlapString(v) => v.to_string(),
            Attr::OverlapBool(v) => v.to_string(),
            Attr::Overlap_scaling(v) => v.to_string(),
            Attr::Overlap_shrink(v) => v.to_string(),
            Attr::PackBool(v) => v.to_string(),
            Attr::PackInt(v) => v.to_string(),
            Attr::Packmode(v) => v.to_string(),
            Attr::PadDouble(v) => v.to_string(),
            Attr::PadPoint(v) => v.to_string(),
            Attr::PageDouble(v) => v.to_string(),
            Attr::PagePoint(v) => v.to_string(),
            Attr::Pagedir(v) => v.to_string(),
            Attr::Pencolor(v) => v.to_string(),
            Attr::Penwidth(v) => v.to_string(),
            Attr::Peripheries(v) => v.to_string(),
            Attr::Pin(v) => v.to_string(),
            Attr::PosPoint(v) => v.to_string(),
            Attr::PosString(v) => v.to_string(),
            Attr::QuadtreeString(v) => v.to_string(),
            Attr::QuadtreeBool(v) => v.to_string(),
            Attr::Quantum(v) => v.to_string(),
            Attr::Radius(v) => v.to_string(),
            Attr::Rank(v) => v.to_string(),
            Attr::Rankdir(v) => v.to_string(),
            Attr::Ranksep(v) => {
                let values: Vec<String> = v.iter().map(|d| d.to_string()).collect();
                values.join(":")
            }
            Attr::RatioDouble(v) => v.to_string(),
            Attr::RatioString(v) => v.to_string(),
            Attr::Rects(v) => v.to_string(),
            Attr::Regular(v) => v.to_string(),
            Attr::Remincross(v) => v.to_string(),
            Attr::Repulsiveforce(v) => v.to_string(),
            Attr::Resolution(v) => v.to_string(),
            Attr::RootString(v) => v.to_string(),
            Attr::RootBool(v) => v.to_string(),
            Attr::Rotate(v) => v.to_string(),
            Attr::Rotation(v) => v.to_string(),
            Attr::Samehead(v) => v.to_string(),
            Attr::Sametail(v) => v.to_string(),
            Attr::Samplepoints(v) => v.to_string(),
            Attr::ScaleDouble(v) => v.to_string(),
            Attr::ScalePoint(v) => v.to_string(),
            Attr::Searchsize(v) => v.to_string(),
            Attr::SepDouble(v) => v.to_string(),
            Attr::SepPoint(v) => v.to_string(),
            Attr::Shape(v) => v.to_string(),
            Attr::Shapefile(v) => v.to_string(),
            Attr::Showboxes(v) => v.to_string(),
            Attr::Sides(v) => v.to_string(),
            Attr::SizeDouble(v) => v.to_string(),
            Attr::SizePoint(v) => v.to_string(),
            Attr::Skew(v) => v.to_string(),
            Attr::Smoothing(v) => v.to_string(),
            Attr::Sortv(v) => v.to_string(),
            Attr::SplinesBool(v) => v.to_string(),
            Attr::SplinesString(v) => v.to_string(),
            Attr::Start(v) => v.to_string(),
            Attr::Style(v) => v.to_string(),
            Attr::Stylesheet(v) => v.to_string(),
            Attr::Tail_lp(v) => v.to_string(),
            Attr::Tailclip(v) => v.to_string(),
            Attr::Tailhref(v) => v.to_string(),
            Attr::Taillabel(v) => v.to_string(),
            Attr::Tailport(v) => v.to_string(),
            Attr::Tailtarget(v) => v.to_string(),
            Attr::Tailtooltip(v) => v.to_string(),
            Attr::TailURL(v) => v.to_string(),
            Attr::Target(v) => v.to_string(),
            Attr::TBbalance(v) => v.to_string(),
            Attr::Tooltip(v) => v.to_string(),
            Attr::Truecolor(v) => v.to_string(),
            Attr::Vertices(v) => {
                let points: Vec<String> = v.iter().map(|p| p.to_string()).collect();
                points.join(":")
            }
            Attr::Viewport(v) => v.to_string(),
            Attr::Voro_margin(v) => v.to_string(),
            Attr::WeightInt(v) => v.to_string(),
            Attr::WeightDouble(v) => v.to_string(),
            Attr::Width(v) => v.to_string(),
            Attr::Xdotversion(v) => v.to_string(),
            Attr::Xlabel(v) => v.to_string(),
            Attr::Xlp(v) => v.to_string(),
            Attr::Z(v) => v.to_string(),
        }
    }
}
