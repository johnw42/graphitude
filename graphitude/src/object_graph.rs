    ...
    F: Fn(&'a N) -> Vec<&'a N>,
{
    ...
    fn neighbors(&self, id: &NodeId<'a, N>) -> Vec<<Self as GraphImpl>::NodeId> {
...
impl<'d, N: Debug, F> GraphImpl for ObjectGraph<'d, N, F>
where
    F: Fn(&'d N) -> Vec<&'d N>,
{
    ...
    fn node_data(&self, id: &NodeId<N>) -> &<Self as GraphImpl>::NodeData {
