...
basic_suite!(run_basic_suite_method: TestSuite = TestSuite::new(10, "hello".to_string()));
basic_suite!(run_basic_suite_literal: TestSuite = TestSuite { param1: 10, param2: "hello".to_string() });
